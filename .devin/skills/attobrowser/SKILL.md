...
Invoke `/Users/lentan/repo/smolfroggo/attobrowser/atto` by absolute path. The
commands below use `atto` as shorthand for that executable, not a shell alias
or a command supplied by this skill.

If dependencies are missing, run
`npm --prefix /Users/lentan/repo/smolfroggo/attobrowser install` without changing
the browser-command working directory.
...
share its selection; this is not a per-agent lock. Keep the state file out of git.
...
- CLI: `/Users/lentan/repo/smolfroggo/attobrowser/atto`
- State: `/Users/lentan/repo/smolfroggo/attobrowser/lib/state.js`
- Transport: `/Users/lentan/repo/smolfroggo/attobrowser/lib/cdp.js`
- Launcher: `/Users/lentan/repo/smolfroggo/attobrowser/lib/launch-chrome.js`
